...
| Area | Documents |
| --- | --- |
| Product | PRD, personas and journeys, metrics plan, roadmap |
| Architecture | System design, tenancy/RBAC, data model, database setup, API conventions, ADRs |
| Security | Threat model, data classification, incident response |
| Operations | Deployment, disaster recovery, support runbook |
